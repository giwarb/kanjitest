...
`}];function id({isOpen:e,message:t,onConfirm:n,onCancel:r}){return e?y.jsx("div",{className:"dialog-overlay",children:y.jsxs("div",{className:"dialog-content",children:[y.jsx("p",{children:t}),y.jsxs("div",{className:"dialog-buttons",children:[y.jsx("button",{type:"button",onClick:r,children:"いいえ"}),y.jsx("button",{type:"button",onClick:n,children:"はい"})]})]})}):null}function ld({isOpen:e,onClose:t,onReset:n,onBackToStart:r,resetLabel:i="さいしょから"}){const[l,o]=I.useState(null),s=()=>{l==="reset"?n():l==="backToStart"&&r&&r(),o(null),t()};return e?y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"menu-dialog-overlay",onClick:t,onKeyDown:a=>a.key==="Escape"&&t(),role:"presentation",children:y.jsxs("div",{className:"menu-dialog",onClick:a=>a.stopPropagation(),onKeyDown:a=>a.key==="Enter"&&a.stopPropagation(),children:[y.jsx("button",{type:"button",onClick:()=>o("reset"),children:i}),r&&y.jsx("button",{type:"button",onClick:()=>o("backToStart"),children:"スタートがめんへ"}),y.jsx("button",{type:"button",onClick:t,children:"とじる"})]})}),l&&y.jsx(id,{isOpen:!0,message:l==="reset"?i==="さいしょから"?"さいしょからやりなおしますか？":"がくしゅうりれきをリセットしますか？":"スタートがめんにもどりますか？",onConfirm:s,onCancel:()=>o(null)})]}):null}function V0({onReset:e,onBackToStart:t,resetLabel:n}){const[r,i]=I.useState(!1);return y.jsxs("div",{className:"header",children:[y.jsx("div",{className:"header-content",children:"かんじれんしゅう アプリ"}),y.jsx("button",{type:"button",className:"menu-button",onClick:()=>i(!0),"aria-label":"メニュー",children:y.jsxs("svg",{viewBox:"0 0 24 24",width:"24",height:"24",role:"img","aria-labelledby":"menuIcon",children:[y.jsx("title",{id:"menuIcon",children:"メニュー"}),y.jsx("path",{fill:"currentColor",d:"M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"})]})}),y.jsx(ld,{isOpen:r,onClose:()=>i(!1),onReset:e,onBackToStart:t,resetLabel:n})]})}function od({onStartPractice:e,memoryManager:t}){const[n,r]=I.useState(0),[i,l]=I.useState(null),[o,s]=I.useState("all"),a=En.length,d=t.getStatistics(En.map(E=>E.id)),v=t.getQuestionsByMode(o,En.map(E=>E.id)),f=[];for(let E=5;E<=Math.min(v.length,a);E+=5)f.push(E);v.length>0&&(f.length===0||f[f.length-1]!==v.length)&&f.push(v.length);const p=()=>{if(!i)return;const E=new Set(v),g=En.filter(k=>E.has(k.id)),c=[...g].sort(()=>Math.random()-.5).slice(0,Math.min(i,g.length));e(c)},m=I.useCallback(()=>{t.clearHistory(),l(null),s("all"),r(E=>E+1)},[t]),x=[{value:"all",label:"すべての もんだい"},{value:"new",label:"まだ といたことない もんだい"},{value:"unsolved",label:"まだ せいかい していない もんだい"},{value:"recent-mistakes",label:"この いっしゅうかんで まちがえた もんだい"}],w=E=>t.getQuestionsByMode(E,En.map(g=>g.id)).length;return y.jsxs("div",{className:"app",children:[y.jsx(V0,{onBackToStart:void 0,onReset:m,resetLabel:"がくしゅうりれきをリセット"}),y.jsx("div",{className:"start-screen-container",children:y.jsxs("div",{className:"start-screen-content",children:[y.jsxs("div",{className:"statistics",children:[y.jsxs("p",{children:["ぜんぶ：",d.total,"もん"]}),y.jsxs("p",{children:["まだといていない：",d.unattempted,"もん"]}),y.jsxs("p",{children:["せいかいした：",d.correct,"もん"]})]}),y.jsxs("div",{className:"mode-section",children:[y.jsx("p",{className:"mode-text",children:"モードをえらんでください："}),y.jsx("div",{className:"mode-buttons",children:x.map(E=>y.jsxs("button",{type:"button",onClick:()=>{s(E.value),l(null)},className:`mode-button ${o===E.value?"selected":""}`,children:[E.label,"（",w(E.value),"もん）"]},E.value))})]}),f.length>0?y.jsxs("div",{className:"question-count-section",children:[y.jsx("p",{className:"question-count-text",children:"もんだいすうをえらんでください："}),y.jsx("div",{className:"question-count-buttons",children:f.map(E=>y.jsxs("button",{type:"button",onClick:()=>l(E),className:`count-button ${i===E?"selected":""}`,children:[E,"もん",E===v.length?"（ぜんぶ）":""]},E))})]}):y.jsx("p",{className:"no-questions-message",children:"このモードで とける もんだいが ありません"}),y.jsx("div",{className:"start-button-container",children:y.jsx("button",{type:"button",onClick:p,className:"start-button",disabled:!i||f.length===0,children:"スタート"})})]})})]})}function sd({currentQuestionNumber:e,totalQuestions:t,question:n,isReviewMode:r}){return y.jsxs(y.Fragment,{children:[y.jsxs("div",{style:{textAlign:"center",marginBottom:"10px"},children:[e," もんめ / ",t," もん"]}),y.jsx("div",{className:"question",dangerouslySetInnerHTML:{__html:n}}),r&&y.jsx("div",{className:"review-mode",children:"ふくしゅうちゅう！"})]})}class ad{constructor(){Fe(this,"storageKey","question_history")}saveResult(t,n,r){const i=this.getHistory(),l=i.find(s=>s.id===t)||{id:t,correctDates:[],incorrectDates:[]};r?l.correctDates.push(n):l.incorrectDates.push(n);const o=i.filter(s=>s.id!==t).concat(l);localStorage.setItem(this.storageKey,JSON.stringify(o))}getHistory(){const t=localStorage.getItem(this.storageKey);return t?JSON.parse(t):[]}getQuestionHistory(t){return this.getHistory().find(n=>n.id===t)}clearHistory(){localStorage.removeItem(this.storageKey)}getUnattemptedIds(t){const n=this.getHistory(),r=new Set(n.map(i=>i.id));return t.filter(i=>!r.has(i))}getUnsolvedIds(t){const n=this.getHistory();return t.filter(r=>{const i=n.find(l=>l.id===r);return!i||i.correctDates.length===0})}getRecentMistakeIds(t){const n=this.getHistory(),r=new Date;return r.setDate(r.getDate()-7),t.filter(i=>{const l=n.find(s=>s.id===i);return l?l.incorrectDates.some(s=>new Date(s)>=r):!1})}getCorrectCount(){return this.getHistory().filter(n=>n.correctDates.length>0).length}getStatistics(t){const n=this.getUnattemptedIds(t).length,r=this.getCorrectCount(),i=this.getUnsolvedIds(t).length,l=this.getRecentMistakeIds(t).length;return{total:t.length,unattempted:n,correct:r,unsolved:i,recentMistakes:l}}getQuestionsByMode(t,n){switch(t){case"all":return[...n];case"new":return this.getUnattemptedIds(n);case"unsolved":return this.getUnsolvedIds(n);case"recent-mistakes":return this.getRecentMistakeIds(n);default:return[]}}}function ud(){const e=I.useRef(null),t=I.useRef(null),n=I.useRef(null),{userStrokes:r,clearStrokes:i}=ed(e.current),[l,o]=I.useState(null),s=I.useRef(new ad),[a,d]=I.useState(""),[v,f]=I.useState(""),[p,m]=I.useState(!1),[x,w]=I.useState(!1),[E,g]=I.useState(!1),[u,c]=I.useState(""),[k,S]=I.useState(null),C=I.useCallback(()=>{if(l)if(l.isComplete()){const W=l.getScore(),M=l.getResults();S({score:W,results:M})}else{const W=l.getCurrentQuestion();if(!W)return;const M=W.sentence.replace(new RegExp(W.target,"g"),"＿＿");d(M),f(W.svg),m(!1),w(!1),g(!1),c(""),i()}},[l,i]);I.useEffect(()=>{const W=qt.restoreFromStorage();W&&o(W)},[]),I.useEffect(()=>{l&&C()},[C,l]);const N=W=>{o(new qt(W))},P=()=>{i(),c("")},$=()=>{var K,_t;if(!l||!n.current||!e.current)return;const W=n.current.querySelector("svg");if(!W)return;const M=(K=e.current)==null?void 0:K.getContext("2d");if(!M)return;const z=(_t=t.current)==null?void 0:_t.getContext("2d");if(!z)return;const j=l.getCurrentQuestion();if(!j)return;const B=Wc(W);if(B.length!==r.length)c(`かくすうがちがうよ！（おてほん: ${B.length}、あなた: ${r.length}）`),g(!0),l.recordResult(!1),s.current.saveResult(j.id,new Date().toISOString(),!1);else{const{strokeResults:Me,normParamsUser:Ut}=Jc(B,r),Be=Me.map(ku=>ku.score),rt=l.isCorrect(Be),vu=l.getScoreText(Be),pu=rt?"せいかい！よくかけました！":"ざんねん！おてほんをよくみよう！";M.clearRect(0,0,e.current.width,e.current.height),Gc(M,Me,Ut,qt.SCORE_THRESHOLD),qc(z,Me,Ut,qt.SCORE_THRESHOLD),w(!0),c(`${pu}（${vu}）`),l.recordResult(rt,Me),s.current.saveResult(j.id,new Date().toISOString(),rt)}m(!0)},R=()=>{C()},ke=()=>{l&&(l.startReviewMode(),C(),S(null))},Qe=()=>{l==null||l.unloadFromStorage(),o(null),S(null)},nt=()=>{l&&(l.reset(),C(),S(null))},ar=()=>{if(!l)return;const W=l.getCurrentQuestion();W&&(g(!0),c("むずかしいですね。おてほんを みてみましょう！"),l.recordResult(!1),s.current.saveResult(W.id,new Date().toISOString(),!1),m(!0))},Ci=r.length>0;if(!l)return y.jsx(od,{onStartPractice:N,memoryManager:s.current});if(k)return y.jsxs("div",{className:"app",children:[y.jsx(V0,{onReset:nt,onBackToStart:Qe}),y.jsx(td,{scoreAndResults:k,onRestartReview:ke,onBackToStart:Qe})]});const mn=p?l.getCurrentQuestionNumber()-1:l.getCurrentQuestionNumber();return y.jsxs("div",{className:"app",children:[y.jsx(V0,{onReset:nt,onBackToStart:Qe}),y.jsx(sd,{currentQuestionNumber:mn,totalQuestions:l.getTotalQuestions(),question:a,isReviewMode:l.isInReviewMode()}),y.jsx(nd,{canvasRef:e,answerCanvasRef:t,answerRef:n,showAnswer:x,showSVG:E,svgContent:v,result:u}),y.jsx(rd,{showNext:p,hasStrokes:Ci,onEvaluate:$,onClear:P,onDontKnow:ar,onNextQuestion:R})]})}const fu=document.getElementById("root");if(!fu)throw new Error("Root element not found");Ji.createRoot(fu).render(y.jsx(Ou.StrictMode,{children:y.jsx(ud,{})}));
